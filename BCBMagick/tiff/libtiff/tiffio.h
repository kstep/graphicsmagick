...
/*
 * Borland specific modifications for DLL
 */ 
...
extern TIFFEXPORT int TIFFIsCODECConfigured(uint16);
extern TIFFEXPORT TIFFCodec* TIFFGetConfiguredCODECs(void);
...
*/
extern TIFFEXPORT int  TIFFGetTagListCount( TIFF * );
extern TIFFEXPORT ttag_t TIFFGetTagListEntry( TIFF *, int tag_index );
...
extern TIFFEXPORT void TIFFMergeFieldInfo(TIFF*, const TIFFFieldInfo[], int);
extern TIFFEXPORT const TIFFFieldInfo* TIFFFindFieldInfo(TIFF*, ttag_t, TIFFDataType);
extern TIFFEXPORT const TIFFFieldInfo* TIFFFindFieldInfoByName(TIFF* , const char *,
						     TIFFDataType);
extern TIFFEXPORT const TIFFFieldInfo* TIFFFieldWithTag(TIFF*, ttag_t);
extern TIFFEXPORT const TIFFFieldInfo* TIFFFieldWithName(TIFF*, const char *);
...
extern TIFFEXPORT TIFFTagMethods *TIFFAccessTagMethods( TIFF * );
extern TIFFEXPORT void *TIFFGetClientInfo( TIFF *, const char * );
extern TIFFEXPORT void TIFFSetClientInfo( TIFF *, void *, const char * );

extern TIFFEXPORT void TIFFCleanup(TIFF*);
...
extern TIFFEXPORT int TIFFReadCustomDirectory(TIFF*, toff_t, const TIFFFieldInfo[],
					    size_t);
extern TIFFEXPORT int TIFFReadEXIFDirectory(TIFF*, toff_t);
...
extern TIFFEXPORT tsize_t TIFFRawStripSize(TIFF*, tstrip_t);
...
extern TIFFEXPORT int TIFFSetFileno(TIFF*, int);
extern TIFFEXPORT thandle_t TIFFClientdata(TIFF*);
extern TIFFEXPORT thandle_t TIFFSetClientdata(TIFF*, thandle_t);
extern TIFFEXPORT int TIFFGetMode(TIFF*);
extern TIFFEXPORT int TIFFSetMode(TIFF*, int);
...
extern TIFFEXPORT int TIFFIsBigEndian(TIFF*);
extern TIFFEXPORT TIFFReadWriteProc TIFFGetReadProc(TIFF*);
extern TIFFEXPORT TIFFReadWriteProc TIFFGetWriteProc(TIFF*);
extern TIFFEXPORT TIFFSeekProc TIFFGetSeekProc(TIFF*);
extern TIFFEXPORT TIFFCloseProc TIFFGetCloseProc(TIFF*);
extern TIFFEXPORT TIFFSizeProc TIFFGetSizeProc(TIFF*);
extern TIFFEXPORT TIFFMapFileProc TIFFGetMapFileProc(TIFF*);
extern TIFFEXPORT TIFFUnmapFileProc TIFFGetUnmapFileProc(TIFF*);
...
extern TIFFEXPORT int TIFFSetupStrips(TIFF *);
extern TIFFEXPORT int TIFFWriteCheck(TIFF*, int, const char *);
extern TIFFEXPORT void TIFFFreeDirectory(TIFF*);
...
extern TIFFEXPORT int TIFFCheckpointDirectory(TIFF *);
extern TIFFEXPORT int TIFFRewriteDirectory(TIFF *);
...
extern TIFFEXPORT int TIFFReadRGBAImageOriented(TIFF*, uint32, uint32, uint32*,
...
extern TIFFEXPORT int TIFFReadRGBAImageOriented(TIFF*, uint32, uint32, uint32*, int, int);
#endif
...
# ifdef __WIN32__
extern TIFFEXPORT TIFF* TIFFOpenW(const wchar_t*, const char*);
# endif /* __WIN32__ */
...
extern TIFFEXPORT const char* TIFFSetFileName(TIFF*, const char *);
extern TIFFEXPORT void TIFFError(const char*, const char*, ...);
extern TIFFEXPORT void TIFFErrorExt(thandle_t, const char*, const char*, ...);
extern TIFFEXPORT void TIFFWarning(const char*, const char*, ...);
extern TIFFEXPORT void TIFFWarningExt(thandle_t, const char*, const char*, ...);
extern TIFFEXPORT TIFFErrorHandler TIFFSetErrorHandler(TIFFErrorHandler);
extern TIFFEXPORT TIFFErrorHandlerExt TIFFSetErrorHandlerExt(TIFFErrorHandlerExt);
extern TIFFEXPORT TIFFErrorHandler TIFFSetWarningHandler(TIFFErrorHandler);
extern TIFFEXPORT TIFFErrorHandlerExt TIFFSetWarningHandlerExt(TIFFErrorHandlerExt);
...
extern TIFFEXPORT int TIFFDataWidth(TIFFDataType);    /* table of tag datatype widths */
...
extern TIFFEXPORT void TIFFSwabArrayOfTriples(uint8*, unsigned long);
...
#define UVSCALE		410.
extern TIFFEXPORT double LogL16toY(int);
extern TIFFEXPORT double LogL10toY(int);
extern TIFFEXPORT void XYZtoRGB24(float*, uint8*);
extern TIFFEXPORT int uv_decode(double*, double*, int);
extern TIFFEXPORT void LogLuv24toXYZ(uint32, float*);
extern TIFFEXPORT void LogLuv32toXYZ(uint32, float*);
#if defined(c_plusplus) || defined(__cplusplus)
extern TIFFEXPORT int LogL16fromY(double, int = SGILOGENCODE_NODITHER);
extern TIFFEXPORT int LogL10fromY(double, int = SGILOGENCODE_NODITHER);
extern TIFFEXPORT int uv_encode(double, double, int = SGILOGENCODE_NODITHER);
extern TIFFEXPORT uint32 LogLuv24fromXYZ(float*, int = SGILOGENCODE_NODITHER);
extern TIFFEXPORT uint32 LogLuv32fromXYZ(float*, int = SGILOGENCODE_NODITHER);
#else
extern TIFFEXPORT int LogL16fromY(double, int);
extern TIFFEXPORT int LogL10fromY(double, int);
extern TIFFEXPORT int uv_encode(double, double, int);
extern TIFFEXPORT uint32 LogLuv24fromXYZ(float*, int);
extern TIFFEXPORT uint32 LogLuv32fromXYZ(float*, int);
#endif
#endif /* LOGLUV_PUBLIC */
    
extern TIFFEXPORT int TIFFCIELabToRGBInit(TIFFCIELabToRGB*, TIFFDisplay *, float*);
extern TIFFEXPORT void TIFFCIELabToXYZ(TIFFCIELabToRGB *, uint32, int32, int32,
			    float *, float *, float *);
extern TIFFEXPORT void TIFFXYZToRGB(TIFFCIELabToRGB *, float, float, float,
			 uint32 *, uint32 *, uint32 *);

extern TIFFEXPORT int TIFFYCbCrToRGBInit(TIFFYCbCrToRGB*, float*, float*);
extern TIFFEXPORT void TIFFYCbCrtoRGB(TIFFYCbCrToRGB *, uint32, int32, int32,
			   uint32 *, uint32 *, uint32 *);
