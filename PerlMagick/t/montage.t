...
#
testMontage( q//,
  q/font=>'Arial', background=>'#696e7e', label=>''/,
...
++$test;
testMontage( q//,
  q/font=>'Arial', background=>'#696e7e', label=>'', geometry=>'90x80+5+5>', gravity=>'Center'/,
...
++$test;
testMontage( q//,
  q/font=>'Arial', background=>'#696e7e', label=>'', geometry=>'90x80+5+5>', gravity=>'NorthWest'/,
...
++$test;
testMontage( q//,
  q/font=>'Arial', background=>'#696e7e', label=>'', geometry=>'90x80+5+5>', gravity=>'North'/,
...
++$test;
testMontage( q//,
  q/font=>'Arial', background=>'#696e7e', label=>'', geometry=>'90x80+5+5>', gravity=>'NorthEast'/,
...
++$test;
testMontage( q//,
  q/font=>'Arial', background=>'#696e7e', label=>'', geometry=>'90x80+5+5>', gravity=>'West'/,
...
++$test;
testMontage( q//,
  q/font=>'Arial', background=>'#696e7e', label=>'', geometry=>'90x80+5+5>', gravity=>'East'/,
...
++$test;
testMontage( q//,
  q/font=>'Arial', background=>'#696e7e', label=>'', geometry=>'90x80+5+5>', gravity=>'SouthWest'/,
...
++$test;
testMontage( q//,
  q/font=>'Arial', background=>'#696e7e', label=>'', geometry=>'90x80+5+5>', gravity=>'South'/,
...
++$test;
testMontage( q//,
  q/font=>'Arial', background=>'#696e7e', label=>'', geometry=>'90x80+5+5>', gravity=>'SouthEast'/,
  'c5d36925275d62749504ee43c23646dd5717192b7920a912b4c868cac27a3beb');

#
# 11) Test Framed Montage
#
# Image border color 'bordercolor' controls frame font=>'Arial', background color
# Image matte color 'mattecolor' controls frame color
# Image pen color 'pen' controls label text foreground color
++$test;
testMontage( q/bordercolor=>'blue', mattecolor=>'red'/, 
  q/font=>'Arial', background=>'#696e7e', label=>'', tile=>'4x4', geometry=>'90x80+3+3>', frame=>'8x10',
  borderwidth=>'0', gravity=>'Center', font=>'Arial', background=>'gray'/,
...
++$test;
testMontage( q/bordercolor=>'blue', mattecolor=>'red'/, 
  q/font=>'Arial', background=>'#696e7e', label=>'', tile=>'4x4', geometry=>'90x80+6+6>', frame=>'8x10',
  borderwidth=>'0', gravity=>'Center', shadow=>'True',font=>'Arial', background=>'gray'/,
...
#
# 13) Test Framed Montage with drop-shadows and font=>'Arial', background texture
#
++$test;
testMontage( q/bordercolor=>'blue', mattecolor=>'red'/, 
  q/font=>'Arial', background=>'#696e7e', label=>'', tile=>'4x4', geometry=>'90x80+6+6>', frame=>'8x10',
...
++$test;
testMontage( q//,
  q/font=>'Arial', background=>'#696e7e', label=>'', tile=>'4x4', geometry=>'90x80+6+6>', frame=>'False',
  borderwidth=>'0', gravity=>'Center', font=>'Arial', background=>'gray'/,
...
testMontage( q/bordercolor=>'red'/, 
  q/font=>'Arial', background=>'#696e7e', label=>'', tile=>'4x4', geometry=>'90x80+6+6>', frame=>'False',
  borderwidth=>'5', gravity=>'Center', font=>'Arial', background=>'gray'/,
...
++$test;
testMontage( q//,
  q/font=>'Arial', background=>'#696e7e', label=>'', tile=>'16x1', geometry=>'90x80+0+0>', frame=>'False',
  borderwidth=>'0', gravity=>'Center', font=>'Arial', background=>'gray'/,
...
++$test;
testMontage( q//,
  q/font=>'Arial', background=>'#696e7e', label=>'', tile=>'4x4', geometry=>'90x80>', mode=>'Concatenate'/,
...
++$test;
testMontage( q//, 
  q/font=>'Arial', background=>'#696e7e', label=>'', tile=>'4x4', geometry=>'+0+0', frame=>'False', shadow=>'False',
  borderwidth=>'0', font=>'Arial', background=>'gray'/,
