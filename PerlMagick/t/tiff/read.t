...
#
# 3) Test reading PseudoColor (256 color)
#
++$test;
...
#
# 4) Test reading PseudoColor using contiguous planar packing
#
++$test;
...
#
# 5) Test reading PseudoColor using seperate planes
#
++$test;
...
#
# 6) Test Reading TrueColor (8-bit)
# 
++$test;
...
#
# 7) Test Reading TrueColor (16-bit)
#
++$test;
...
#
# 8) Test Reading 8-bit TrueColor Tiled (32x32 tiles)
# 
++$test;
...
#
# 9) Test Reading 8-bit TrueColor Tiled (8 rows per strip)
# 
++$test;
...
#
# 10) Test Reading Grayscale 4-bit
#
++$test;
...
#
# 11) Test Reading Grayscale 8-bit
# 
++$test;
...
#
# 12) Test Reading Grayscale 8-bit + matte
# 
++$test;
...
#
# 13) Test Reading Grayscale 12-bit
# 
++$test;
...
#
# 14) Test Reading Grayscale 16-bit
# 
++$test;
