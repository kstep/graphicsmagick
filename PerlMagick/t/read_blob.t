...
#
++$test;
testReadBlobSized( 'TILE:input.miff',
  '140x92',
  8,
...
print("CMYK format ...\n");
++$test;
testReadBlobSized( 'input_70x46.cmyk',
   '70x46',
   8,
...
print("GRAY format ...\n");
++$test;
testReadBlobSized( 'input_70x46.gray',
   '70x46',
   8,
   '0e54b24352da9f7d0966c9b882988b9124b6b7fd7493ff266f4c03382b94a42a' );
...
print("RGB format ...\n");
++$test;
testReadBlobSized( 'input_70x46.rgb',
   '70x46',
   8,
   '8b19185a62241bd7b79ecf3f619711f4ebbedd73eaeca0366f05778762b6614f' );
...
print("RGBA format ...\n");
++$test;
testReadBlobSized( 'input_70x46.rgba',
   '70x46',
   8,
   '8b19185a62241bd7b79ecf3f619711f4ebbedd73eaeca0366f05778762b6614f' );
...
print("UYVY format ...\n");
++$test;
testReadBlobSized( 'input_70x46.uyvy',
   '70x46',
   0,
