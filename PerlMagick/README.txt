Introduction 
    ...
    PerlMagick, version 4.22, is an objected-oriented Perl interface to
    ...
    for Web CGI scripts. You must have ImageMagick 4.2.1 above and Perl
...
Installation 
    ...
    Get the PerlMagick distribution and type the following: 
        ...
        gunzip PerlMagick-4.22.tar.gz
        tar xvf PerlMagick-4.22.tar
        cd Magick
