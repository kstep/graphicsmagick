/*  RAL-CGM Interpreter header file: @(#) cgmelem.h  version 3.4
 *
 ...
 *
 *
 *  Description: CGM Elements as constants (character encoding values)
 *
 * Modification log:
 *
 *   2 Aug 91 RTP  Add SCCS id
 *   7 Aug 91 RTP  Use CGMVERSION value instead of defined VERSIONx
 *   7 Mar 95 RTP  Remove count of CGM Elements
 */
