/* libwmf ("ipa/gd/region.h"): library for wmf conversion
...
void wmf_gd_region_frame (wmfAPI* API,wmfPolyRectangle_t* poly_rect)
...
void wmf_gd_region_paint (wmfAPI* API,wmfPolyRectangle_t* poly_rect)
{	wmf_gd_t* ddata = WMF_GD_GetData (API);
...
void wmf_gd_region_clip (wmfAPI* API,wmfPolyRectangle_t* poly_rect)
{	wmf_gd_t* ddata = WMF_GD_GetData (API);
