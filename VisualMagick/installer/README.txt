...
2) Open workspace VisualMagick\VisualDynamicMT.dsw by double-clicking from
   ...
   2c) Build -> "Set Active Configuration" -> "GraphicsMagickObject - Win32
       Release" -> OK
   2d) Build -> "Build GraphicsMagickObject.dll"
...
4) Open VisualMagick\installer\GraphicsMagick-16.iss by double-clicking from Windows Explorer.
   ...
   4c) Distribution package is available as
       VisualMagick\bin\GraphicsMagick-1.0.0-Q8-windows.exe
