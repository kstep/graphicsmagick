...
%exedir%rwfile.exe -debug %events% -filespec "out_bilevel_%d" -size 70x46 %bilevel_file% CMYK
%exedir%rwfile.exe -debug %events% -filespec "out_gray_%d" -size 70x46 %gray_file% CMYK
%exedir%rwfile.exe -debug %events% -filespec "out_pallette_%d" -size 70x46 %pallette_file% CMYK
...
%exedir%rwfile.exe -debug %events% -filespec "out_bilevel_%d" -size 70x46 %bilevel_file% MONO
%exedir%rwfile.exe -debug %events% -filespec "out_gray_%d" -size 70x46 %gray_file% MONO
%exedir%rwfile.exe -debug %events% -filespec "out_pallette_%d" -size 70x46 %pallette_file% MONO
%exedir%rwfile.exe -debug %events% -filespec "out_truecolor_%d" -size 70x46 %truecolor_file% MONO
%exedir%rwfile.exe -debug %events% -filespec "out_bilevel_%d" -size 70x46 %bilevel_file% PAL
%exedir%rwfile.exe -debug %events% -filespec "out_gray_%d" -size 70x46 %gray_file% PAL
%exedir%rwfile.exe -debug %events% -filespec "out_pallette_%d" -size 70x46 %pallette_file% PAL
%exedir%rwfile.exe -debug %events% -filespec "out_truecolor_%d" -size 70x46 %truecolor_file% PAL
%exedir%rwfile.exe -debug %events% -filespec "out_bilevel_%d" -size 70x46 %bilevel_file% RGB
%exedir%rwfile.exe -debug %events% -filespec "out_gray_%d" -size 70x46 %gray_file% RGB
%exedir%rwfile.exe -debug %events% -filespec "out_pallette_%d" -size 70x46 %pallette_file% RGB
%exedir%rwfile.exe -debug %events% -filespec "out_truecolor_%d" -size 70x46 %truecolor_file% RGB
%exedir%rwfile.exe -debug %events% -filespec "out_bilevel_%d" -size 70x46 %bilevel_file% RGBA
%exedir%rwfile.exe -debug %events% -filespec "out_gray_%d" -size 70x46 %gray_file% RGBA
%exedir%rwfile.exe -debug %events% -filespec "out_pallette_%d" -size 70x46 %pallette_file% RGBA
%exedir%rwfile.exe -debug %events% -filespec "out_truecolor_%d" -size 70x46 %truecolor_file% RGBA
%exedir%rwfile.exe -debug %events% -filespec "out_bilevel_%d" -size 70x46 %bilevel_file% UYVY
%exedir%rwfile.exe -debug %events% -filespec "out_gray_%d" -size 70x46 %gray_file% UYVY
%exedir%rwfile.exe -debug %events% -filespec "out_pallette_%d" -size 70x46 %pallette_file% UYVY
%exedir%rwfile.exe -debug %events% -filespec "out_truecolor_%d" -size 70x46 %truecolor_file% UYVY
%exedir%rwfile.exe -debug %events% -filespec "out_bilevel_%d" -size 70x46 %bilevel_file% YUV
%exedir%rwfile.exe -debug %events% -filespec "out_gray_%d" -size 70x46 %gray_file% YUV
%exedir%rwfile.exe -debug %events% -filespec "out_pallette_%d" -size 70x46 %pallette_file% YUV
