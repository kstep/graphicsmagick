...
{
    printf("\n");
    printf("   Usage: %1 [/-][w|iw|ir] <path to test dir>\n", pszCommand);
    printf("   E.g.:  %1 -m d:\\test\n", pszCommand );
    printf("   Where:\n");
    printf("      /w enables the Word 6 test,\n");
    printf("      /iw creates a file for interop test\n");
    printf("      /ir verfies file created for interop test\n" );    
    printf("   If you use the /m option, make sure you specify an absolute\n");
    printf("   path name as the first parameter.  E.g., don't use \".\\Test\"\n");
    printf("\n");
