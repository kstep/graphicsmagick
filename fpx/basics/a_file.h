...
//  ---------
    ...
    enum mode_Ouverture {   mode_Lecture,
...
inline Boolean Fichier::LectureTableau(unsigned char *array, int32 nshort) { return Lecture((ptr)array, nshort * sizeof(*array)); }
...
inline Boolean Fichier::Ecriture(Boolean x) { return Ecriture(&x,sizeof(Boolean)); }
inline Boolean Fichier::Lecture(Boolean* x) { return Lecture(x,sizeof(Boolean)); }
inline Boolean Fichier::LectureTexte(unsigned char* text, long nb) { return Lecture(text, nb); }
inline Boolean Fichier::EcritureTexte(const Chaine& string) { return Ecriture(string.Texte(), string.Longueur()); }
inline Boolean Fichier::EcritureTexteOffset(const Chaine& string, long offset) { return Ecriture(string.Texte(),string.Longueur(),offset); }
