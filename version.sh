...
PACKAGE_RELEASE_DATE="2012-10-13"
...
#
MAGICK_LIBRARY_CURRENT=13

MAGICK_LIBRARY_REVISION=0
MAGICK_LIBRARY_AGE=10

#
# Magick++ library versioning
#
MAGICK_PLUS_PLUS_LIBRARY_CURRENT=9
MAGICK_PLUS_PLUS_LIBRARY_REVISION=1
MAGICK_PLUS_PLUS_LIBRARY_AGE=6

#
# Magick Wand library versioning
#
MAGICK_WAND_LIBRARY_CURRENT=7
MAGICK_WAND_LIBRARY_REVISION=1
MAGICK_WAND_LIBRARY_AGE=5
