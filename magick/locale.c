...
const char *AllocateManagedString(const char *s)
{
  char
    *cs;
...
const char *GetLocaleMessageFromTag(const char *tag)
{
 ...
 */
static const char *SeverityToTag(const ExceptionType severity)
{
  register int
    i;
 ...
 */
const char *GetLocaleMessageFromSeverityAndTag(const ExceptionType severity,
  const char *tag)
{
  char
 ...
 */
const char *GetLocaleMessageFromID(const int id)
{
