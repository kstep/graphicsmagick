...
#define MagickVersion \
  "@(#)ImageMagick 5.4.6 06/01/02 Q:8 http://www.imagemagick.org"
#elif QuantumDepth == 16
#define MagickVersion \
  "@(#)ImageMagick 5.4.6 06/01/02 Q:16 http://www.imagemagick.org"
#else
#define MagickVersion \
  "@(#)ImageMagick 5.4.6 06/01/02 http://www.imagemagick.org"
#endif
