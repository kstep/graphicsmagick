...
typedef unsigned int
  (*MonitorHandler)(const char *,const ExtendedSignedIntegralType,const size_t,ExceptionInfo *);

/*
...
extern MagickExport unsigned int
  MagickMonitor(const char *,const ExtendedSignedIntegralType,const size_t,ExceptionInfo *);
