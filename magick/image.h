...
*/
inline PixelPacket AlphaComposite(const PixelPacket *p,
...
inline unsigned int ColorMatch(const PixelPacket *color,
...
inline Quantum Downscale(const Quantum quantum)
{
#if QuantumDepth == 8
  return(quantum);
#else
...
inline Quantum Intensity(const PixelPacket *pixel)
{
  return((9798L*pixel->red+19235L*pixel->green+3735L*pixel->blue)/32768L);
}

inline Quantum Upscale(const Quantum quantum)
{
#if QuantumDepth == 8
  return(quantum);
#else
...
inline unsigned short XDownscale(const unsigned short quantum)
{
#if QuantumDepth == 8
  return(quantum/257);
#else
...
inline unsigned short XUpscale(const unsigned short quantum)
{
#if QuantumDepth == 8
  return(257*quantum);
#else
