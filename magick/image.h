...

/*
  Inline pixel methods.
*/
extern MagickExport inline PixelPacket AlphaComposite(const PixelPacket *p,
...
extern MagickExport inline unsigned int ColorMatch(const PixelPacket *color,
...
extern MagickExport inline Quantum Downscale(const unsigned long quantum)
{
#if QuantumDepth == 8
...
extern MagickExport inline Quantum Intensity(const PixelPacket *pixel)
{
  Quantum
    intensity;
...
extern MagickExport inline Quantum Upscale(const unsigned long quantum)
{
#if QuantumDepth == 8
  return((Quantum) quantum);
#else
...
extern MagickExport inline unsigned short XDownscale(const unsigned long quantum)
{
#if QuantumDepth == 8
...
extern MagickExport inline unsigned short XUpscale(const unsigned long quantum)
{
#if QuantumDepth == 8
