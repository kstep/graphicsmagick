...
static DicomInfo
  dicom_info[] =
  {
    ...
    { 0x0000, 0x4000, "AT", "Dialog Receiver" },
    { 0x0000, 0x4010, "AT", "Terminal Type" },
    { 0x0000, 0x5010, "SH", "Message Set ID" },
    { 0x0000, 0x5020, "SH", "End Message Set ID" },
    { 0x0000, 0x5110, "AT", "Display Format" },
    { 0x0000, 0x5120, "AT", "Page Position ID" },
    { 0x0000, 0x5130, "CS", "Text Format ID" },
    { 0x0000, 0x5140, "CS", "Normal Reverse" },
    { 0x0000, 0x5150, "CS", "Add Gray Scale" },
    { 0x0000, 0x5160, "CS", "Borders" },
    { 0x0000, 0x5170, "IS", "Copies" },
    { 0x0000, 0x5180, "CS", "Old Magnification Type" },
    { 0x0000, 0x5190, "CS", "Erase" },
    { 0x0000, 0x51a0, "CS", "Print" },
    { 0x0000, 0x51b0, "US", "Overlays" },
    { 0x0002, 0x0000, "UL", "Group Length" },
    { 0x0002, 0x0001, "OB", "File Meta Information Version" },
    { 0x0002, 0x0002, "UI", "Media Stored SOP Class UID" },
    { 0x0002, 0x0003, "UI", "Media Stored SOP Instance UID" },
    ...
    { 0x0004, 0x1200, "up", "Offset of 1st Dir Record of Root Dir Entity" },
    { 0x0004, 0x1202, "up", "Offset of Last Dir Record of Root Dir Entity" },
    { 0x0004, 0x1212, "US", "File-set Consistency Flag" },
    { 0x0004, 0x1220, "SQ", "Directory Record Sequence" },
    { 0x0004, 0x1400, "up", "Offset of next directry record" },
    { 0x0004, 0x1410, "US", "Record in-use flag" },
    { 0x0004, 0x1420, "up", "Offset of referenced lower-level dir entity" },
    ...
    { 0x0008, 0x0010, "CS", "Recognition Code" },
    ...
    { 0x0008, 0x0041, "LT", "Data Set Subtype" },
    ...
    { 0x0009, 0x0000, "xx", "SPI Identifying Group Length" },
    { 0x0009, 0x0010, "xx", "SPI Comments" },
    { 0x0009, 0x0015, "xx", "SPI Unique Identifier" },
    { 0x0009, 0x0016, "xx", "SPI DESC Descriptor" },
    { 0x0009, 0x0017, "xx", "SPI Special Identifier" },
    { 0x0009, 0x0040, "xx", "SPI Data Object Type" },
    { 0x0009, 0x0041, "xx", "SPI Data Object Subtype" },
    { 0x0009, 0x0061, "xx", "SPI Modality Type Extension" },
    { 0x0009, 0x00a0, "xx", "SPI Resulting Diagnosis" },
    { 0x0009, 0x00a1, "xx", "SPI Report Date" },
    { 0x0009, 0x00a2, "xx", "SPI Report Time" },
    ...
    { 0x0010, 0x1000, "LO", "Other Patient's IDs" },
    ...
    { 0x0011, 0x0000, "xx", "SPI Patient Group Length" },
    { 0x0011, 0x0010, "xx", "SPI Shadow Owner Code - SPI ID" },
    { 0x0011, 0x0011, "xx", "SPI Shadow Owner Code - Siemens CMS ID" },
    { 0x0011, 0x1010, "xx", "SPI Organ" },
    { 0x0011, 0x1015, "xx", "SPI Allergy Indicator" },
    { 0x0011, 0x1020, "xx", "SPI Pregnancy" },
    { 0x0011, 0x1110, "xx", "SPI Registration Date" },
    { 0x0011, 0x1111, "xx", "SPI Registration Time" },
    { 0x0011, 0x1123, "xx", "SPI Used Patient Weight" },
    ...
    { 0x0018, 0x0036, "SQ", "Interventional Therapy Sequence" },
    { 0x0018, 0x0037, "CS", "Therapy Type" },
    { 0x0018, 0x0038, "CS", "Interventional Status" },
    ...
    { 0x0018, 0x1046, "DS", "Contrast Flow Rate(s)" },
    { 0x0018, 0x1047, "DS", "Contrast Flow Duration(s)" },
    { 0x0018, 0x1048, "CS", "Contrast/Bolus Intredient" },
    { 0x0018, 0x1049, "DS", "Contrast/Bolus Intredient Concentration" },
    ...
    { 0x0018, 0x115e, "DS", "Image Area Dose Produce" },
    ...
    { 0x0018, 0x1310, "xs", "Acquisition Matrix" },
    ...
    { 0x0018, 0x1450, "CS", "Column Angulation" },
    ...
    { 0x0018, 0x1606, "IS", "Shutter Upper Vertical Edge" },
    { 0x0018, 0x1608, "IS", "Shutter Lower Vertical Edge" },
    ...
    { 0x0018, 0x6036, "FD", "Sterring Angle" },
    ...
    { 0x0019, 0x0000, "xx", "SPI Acquisition Group Length" },
    { 0x0019, 0x0010, "xx", "SPI Shadow Owner Code - Siemens CMS ID" },
    { 0x0019, 0x0011, "xx", "SPI Shadow Owner Code - Siemens CT ID" },
    { 0x0019, 0x0012, "xx", "SPI Shadow Owner Code - Siemens MR ID" },
    { 0x0019, 0x0013, "xx", "SPI Shadow Owner Code - Siemens CT Adjust ID" },
    { 0x0019, 0x0014, "xx", "SPI Shadow Owner Code - Siemens MR Adjust ID" },
    { 0x0019, 0x0015, "xx", "SPI Shadow Owner Code - Siemens Acquisition ID" },
    { 0x0020, 0x0000, "UL", "Image Group Length" },
    ...
    { 0x0020, 0x0080, "CS", "Masking Image" },
    ...
    { 0x0020, 0x1208, "IS", "Number of Study Related Images" },
    { 0x0020, 0x1209, "IS", "" },
    { 0x0020, 0x3100, "CS", "" },
    { 0x0020, 0x3401, "CS", "Modifying Device ID" },
    { 0x0020, 0x3402, "CS", "Modified Image ID" },
    { 0x0020, 0x3403, "DA", "Modified Image Date" },
    { 0x0020, 0x3404, "LO", "Modifying Device Manufacturer" },
    { 0x0020, 0x3405, "TM", "Modified Image Time" },
    { 0x0020, 0x3406, "LT", "Modified Image Description" },
    { 0x0020, 0x4000, "LT", "Image Comments" },
    { 0x0020, 0x5000, "AT", "Original Image Identification" },
    { 0x0020, 0x5002, "CS", "Original Image Identification Nomenclature" },
    { 0x0021, 0x0000, "UL", "SPI Image Group Length" },
    ...
    { 0x0028, 0x005f, "CS", "Compression Recognition Code" },
    ...
    { 0x0028, 0x0110, "US", "Smallest Image Pixel Value in Plane" },
    { 0x0028, 0x0111, "US", "Largest Image Pixel Value in Plane" },
    { 0x0028, 0x0120, "US", "Pixel Padding Value" },
    { 0x0028, 0x0200, "US", "Image Location" },
    { 0x0028, 0x0400, "CS", "Transform Label" },
    { 0x0028, 0x0401, "CS", "Transform Version Number" },
    { 0x0028, 0x0402, "US", "Number Of Transform Steps" },
    { 0x0028, 0x0403, "CS", "Sequence Of Compressed Data" },
    { 0x0028, 0x0404, "AT", "Details Of Coefficients" },
    { 0x0028, 0x0410, "US", "" },
    { 0x0028, 0x0411, "US", "" },
    { 0x0028, 0x0412, "CS", "" },
    { 0x0028, 0x0413, "AT", "" },
    { 0x0028, 0x0700, "CS", "DCT Label" },
    ...
    { 0x0029, 0x0000, "UL", "SPI Image Presentation Group Length" },
    { 0x0029, 0x0060, "UL", "SPI Compression Algorithm" },
    ...
    { 0x0033, 0x0000, "UL", "SPI Study Group Length" },
    ...
    { 0x0039, 0x0000, "UL", "SPI Visit Group Length" },
    { 0x0040, 0x0000, "UL", "" },
    ...
    { 0x0040, 0x2004, "DA", "Issuing Date of Imaging Service Request" },
    { 0x0040, 0x2005, "TM", "Issuing Time of Imaging Service Request" },
    ...
    { 0x0040, 0x2009, "SH", "Order Entererœs Location" },
    { 0x0040, 0x2010, "SH", "Order Callback Phone Number" },
    { 0x0040, 0x2400, "LT", "Imaging Service Request Comments" },
    { 0x0040, 0x3001, "LO", "Patient Data Confidentiality Constraint Description" },
    { 0x0040, 0xa043, "SQ", "" },
    { 0x0040, 0xa121, "DA", "" },
    { 0x0040, 0xa122, "TM", "" },
    { 0x0040, 0xa123, "PN", "" },
    ...
    { 0x0040, 0xa354, "LO", "" },
    { 0x0040, 0xa992, "ST", "" },
    { 0x0041, 0x0000, "UL", "SPI Folder Group Length" },
    { 0x0041, 0x0010, "LO", "SPI Folder Type" },
    { 0x0041, 0x0080, "LO", "" },
    { 0x0041, 0x1000, "LT", "" },
    { 0x0041, 0x1010, "SQ", "" },
    { 0x0041, 0x1011, "UL", "" },
    ...
    { 0x0054, 0x0222, "SQ", "View Angulation Modifier Code Sequence" },
    ...
    { 0x1000, 0x0014, "US", "" },
    { 0x1000, 0x0015, "US", "" },
    { 0x1010, 0x0000, "UL", "Zonal Map Group Length" },
    { 0x1010, 0x0004, "US", "Zonal Map" },
    ...
    { 0x2130, 0x0080, "SQ", "" },
    { 0x2130, 0x0090, "SQ", "" },
    { 0x3002, 0x0002, "SH", "RT Image Type" },
    { 0x3002, 0x0003, "LO", "" },
    { 0x3002, 0x0004, "ST", "RT Image Plane" },
    { 0x3002, 0x0006, "UL", "Image Receptor Angle" },
    { 0x3002, 0x0008, "UL", "RT Image Orientation" },
    { 0x3002, 0x000a, "CS", "RT Image Position" },
    { 0x3002, 0x000c, "CS", "" },
    { 0x3002, 0x000e, "DS", "" },
    { 0x3002, 0x0010, "DS", "" },
    { 0x3002, 0x0011, "DS", "" },
    ...
    { 0x3002, 0x0032, "DS", "Imaging MU" },
    { 0x3002, 0x0034, "UL", "Beam-on Time" },
    { 0x3004, 0x0001, "CS", "" },
    ...
    { 0x3004, 0x0072, "DS", "" },
    { 0x3004, 0x0074, "DS", "" },
    { 0x3006, 0x0002, "SH", "ROI Set Label" },
    { 0x3006, 0x0004, "LO", "ROI Set Name" },
    { 0x3006, 0x0006, "ST", "ROI Set Description" },
    { 0x3006, 0x0008, "DA", "ROI Set Date" },
    { 0x3006, 0x0009, "TM", "ROI Set Time" },
    { 0x3006, 0x0010, "SQ", "Referenced Frame of Reference Sequence" },
    { 0x3006, 0x0012, "SQ", "" },
    { 0x3006, 0x0014, "SQ", "" },
    { 0x3006, 0x0016, "SQ", "" },
    { 0x3006, 0x0020, "SQ", "ROI Sequence" },
    { 0x3006, 0x0022, "IS", "ROI ID" },
    ...
    { 0x3006, 0x0030, "SQ", "Reference ROI Sequence" },
    { 0x3006, 0x0032, "UL", "Referenced ROI ID" },
    { 0x3006, 0x0033, "CS", "" },
    { 0x3006, 0x0034, "UL", "ROI Relationship" },
    { 0x3006, 0x0036, "CS", "ROI Contour Generation Algorithm" },
    { 0x3006, 0x0038, "LO", "ROI Contour Generation Description" },
    { 0x3006, 0x0039, "SQ", "" },
    { 0x3006, 0x0040, "SQ", "Contour Sequence" },
    { 0x3006, 0x0042, "CS", "Contour Geometric Type" },
    { 0x3006, 0x0044, "DS", "Contour Thickness" },
    { 0x3006, 0x0045, "DS", "" },
    { 0x3006, 0x0046, "IS", "Number of Contour Points" },
    { 0x3006, 0x0050, "DS", "Contour Data" },
    { 0x3006, 0x0080, "SQ", "ROI Observations Sequence" },
    { 0x3006, 0x0082, "IS", "ROI Observations ID" },
    { 0x3006, 0x0084, "IS", "Referenced ROI ID" },
    { 0x3006, 0x0085, "SH", "" },
    { 0x3006, 0x0086, "SQ", "ROI Identification Code" },
    { 0x3006, 0x0088, "ST", "" },
    { 0x3006, 0x00a0, "SQ", "ROI Interpretations Sequence" },
    { 0x3006, 0x00a2, "UL", "Referenced ROI Observations ID" },
    { 0x3006, 0x00a4, "CS", "ROI Interpreted Type" },
    { 0x3006, 0x00a6, "PN", "ROI Interpreter" },
    { 0x3006, 0x00b0, "SQ", "ROI Density Sequence" },
    { 0x3006, 0x00b2, "CS", "ROI Density Unit" },
    { 0x3006, 0x00b4, "DS", "ROI Density Value" },
    { 0x3006, 0x00c0, "SQ", "" },
    { 0x3006, 0x00c2, "UI", "" },
    { 0x3006, 0x00c4, "CS", "" },
    { 0x3006, 0x00c6, "DS", "" },
    { 0x3006, 0x00c8, "LO", "" },
    { 0x3008, 0x0010, "UL", "Measured Dose Sequence" },
    { 0x3008, 0x0012, "UL", "Measured Dose Description" },
    { 0x3008, 0x0014, "UL", "Measured Dose Type" },
    { 0x3008, 0x0016, "UL", "Measured Dose Value" },
    { 0x3008, 0x0020, "UL", "Treatment Session Beam Sequence" },
    { 0x3008, 0x0022, "UL", "Current Fraction Number" },
    { 0x3008, 0x0024, "UL", "Treatment Date" },
    { 0x3008, 0x0025, "UL", "Treatment Time" },
    { 0x3008, 0x0028, "UL", "Treatment Delivery Type" },
    { 0x3008, 0x002a, "UL", "Treatment Termination Status" },
    { 0x3008, 0x002b, "UL", "Treatment Termination Code" },
    { 0x3008, 0x002c, "UL", "Treatment Verification Status" },
    { 0x3008, 0x0032, "UL", "Delivered Meterset Primary Chamber" },
    { 0x3008, 0x0033, "UL", "Specified Meterset Secondary Chamber" },
    { 0x3008, 0x0036, "UL", "Delivered Meterset Primary Chamber" },
    { 0x3008, 0x0037, "UL", "Delivered Meterset Secondary Chamber" },
    { 0x3008, 0x003a, "UL", "Specified Treatment Time" },
    { 0x3008, 0x003b, "UL", "Delivered Treatment Time" },
    { 0x3008, 0x0040, "UL", "Control Point Delivery Sequence" },
    { 0x3008, 0x0042, "UL", "Specified Meterset" },
    { 0x3008, 0x0044, "UL", "Delivered Meterset" },
    { 0x3008, 0x0048, "UL", "Dose Rate Delivered" },
    { 0x3008, 0x0050, "UL", "Treatment Summary Dose Reference Sequence" },
    { 0x3008, 0x0052, "UL", "Cumulative Dose To Dose Reference" },
    { 0x3008, 0x0054, "UL", "First Treatment Date" },
    { 0x3008, 0x0055, "UL", "Most Recent Treatment Date" },
    { 0x3008, 0x0056, "UL", "Final Treatment Date" },
    { 0x3008, 0x0058, "UL", "Number of Treatment Sessions Planned" },
    { 0x3008, 0x005a, "UL", "Number of Treatment Sessions Delivered" },
    { 0x3008, 0x0060, "UL", "Override Sequence" },
    { 0x3008, 0x0062, "UL", "Override Parameter Pointer" },
    { 0x300a, 0x0002, "SH", "Plan Label" },
    { 0x300a, 0x0003, "LO", "Plan Name" },
    { 0x300a, 0x0004, "ST", "Plan Description" },
    { 0x300a, 0x0006, "DA", "Plan Date" },
    { 0x300a, 0x0007, "TM", "Plan Time" },
    { 0x300a, 0x0009, "LO", "Plan Status" },
    { 0x300a, 0x000a, "CS", "Approval Date" },
    { 0x300a, 0x000b, "LO", "Approval Time" },
    { 0x300a, 0x000c, "CS", "Approver Name" },
    { 0x300a, 0x000e, "ST", "Prescription Description" },
    { 0x300a, 0x0010, "SQ", "Dose Reference Sequence" },
    { 0x300a, 0x0012, "IS", "Dose Reference ID" },
    ...
    { 0x300a, 0x002a, "DS", "Sensitive Structure Full-volume Dose" },
    { 0x300a, 0x002b, "DS", "Sensitive Structure Limit Dose" },
    { 0x300a, 0x002c, "DS", "Sensitive Structure Maximum Dose" },
    { 0x300a, 0x002d, "DS", "Sensitive Structure Overdose Volume Fraction" },
    { 0x300a, 0x0040, "SQ", "Tolerance Table Sequence" },
    { 0x300a, 0x0042, "IS", "Tolerance Table ID" },
    { 0x300a, 0x0043, "SH", "" },
    { 0x300a, 0x0044, "DS", "Gantry Angle Tolerance" },
    { 0x300a, 0x0046, "DS", "Collimator Angle Tolerance" },
    { 0x300a, 0x0048, "SQ", "Collimator Tolerance Sequence" },
    { 0x300a, 0x004a, "DS", "Collimator Position Tolerance" },
    ...
    { 0x300a, 0x0055, "CS", "Plan Relationship" },
    { 0x300a, 0x0070, "SQ", "Fraction Group Sequence" },
    { 0x300a, 0x0071, "IS", "Fraction Group ID" },
    ...
    { 0x300a, 0x00a0, "IS", "Number of Sources" },
    { 0x300a, 0x00a2, "DS", "Source Dose Specification Point" },
    { 0x300a, 0x00a4, "DS", "Source Dose" },
    ...
    { 0x300a, 0x00b6, "SQ", "Collimator Sequence" },
    { 0x300a, 0x00b8, "CS", "Collimator Type" },
    { 0x300a, 0x00ba, "DS", "Source-Collimator Distance" },
    { 0x300a, 0x00bc, "IS", "Number of Leaf Pairs" },
    { 0x300a, 0x00be, "DS", "Leaf Position Boundaries" },
    { 0x300a, 0x00c0, "IS", "Beam ID" },
    ...
    { 0x300a, 0x00d2, "IS", "Wedge Type" },
    { 0x300a, 0x00d3, "CS", "Wedge ID" },
    { 0x300a, 0x00d4, "SH", "Wedge Angle" },
    { 0x300a, 0x00d5, "IS", "" },
    ...
    { 0x300a, 0x00eb, "DS", "Compensator Data" },
    { 0x300a, 0x00ec, "DS", "" },
    ...
    { 0x300a, 0x0107, "SQ", "" },
    { 0x300a, 0x0108, "SH", "Electron Applicator Code" },
    { 0x300a, 0x0109, "CS", "" },
    { 0x300a, 0x010a, "LO", "Beam Dose Reference Coefficient" },
    { 0x300a, 0x010c, "DS", "" },
    { 0x300a, 0x010e, "DS", "" },
    ...
    { 0x300a, 0x011a, "SQ", "Collimator Position Sequence" },
    { 0x300a, 0x011c, "DS", "Leaf/Jaw Positions" },
    { 0x300a, 0x011e, "DS", "Gantry Angle" },
    { 0x300a, 0x011f, "CS", "Gantry Rotation Direction" },
    { 0x300a, 0x0120, "DS", "Collimator Angle" },
    { 0x300a, 0x0121, "CS", "Collimator Rotation Direction" },
    ...
    { 0x300a, 0x0134, "DS", "Cumulative Meterset Percentage" },
    { 0x300a, 0x0180, "SQ", "Patient Setup Sequence" },
    { 0x300a, 0x0182, "IS", "Patient Setup ID" },
    ...
    { 0x300a, 0x02d4, "DS", "" },
    { 0x300a, 0x02d6, "DS", "" },
    { 0x300c, 0x0002, "SQ", "Referenced Plan Sequence" },
    { 0x300c, 0x0004, "SQ", "Referenced Beam Sequence" },
    { 0x300c, 0x0006, "IS", "Referenced Beam ID" },
    { 0x300c, 0x0007, "IS", "" },
    { 0x300c, 0x0008, "DS", "Referenced Start Control Point" },
    { 0x300c, 0x0009, "DS", "Referenced End Control Point" },
    { 0x300c, 0x000a, "SQ", "Referenced Source Sequence" },
    { 0x300c, 0x000c, "IS", "Referenced Source ID" },
    { 0x300c, 0x000e, "IS", "" },
    { 0x300c, 0x0020, "SQ", "Referenced Fraction Group Sequence" },
    { 0x300c, 0x0022, "IS", "Referenced Fraction Group ID" },
    { 0x300c, 0x0030, "UL", "Referenced Treatment Record Sequence" },
    ...
    { 0x300c, 0x0051, "IS", "Referenced Dose Reference ID" },
    { 0x300c, 0x0055, "SQ", "" },
    { 0x300c, 0x0060, "SQ", "Referenced Structure Set Sequence" },
    { 0x300c, 0x0062, "UL", "Referenced Structure Sequence" },
    { 0x300c, 0x0064, "UL", "Referenced Structure ID" },
    { 0x300c, 0x006a, "IS", "Referenced Patient Setup ID" },
    { 0x300c, 0x0080, "SQ", "Referenced Dose Sequence" },
    { 0x300c, 0x0090, "UL", "RT Operator Name" },
    { 0x300c, 0x00a0, "IS", "Referenced Tolerance Table ID" },
    { 0x300c, 0x00b0, "SQ", "Referenced Bolus Sequence" },
    { 0x300c, 0x00c0, "IS", "Referenced Wedge ID" },
    { 0x300c, 0x00d0, "IS", "Referenced Compensator ID" },
    { 0x300c, 0x00e0, "IS", "Referenced Block ID" },
    { 0x300c, 0x00f0, "IS", "Referenced Control Point" },
    { 0x300e, 0x0002, "CS", "RT Study Status" },
    { 0x300e, 0x0004, "DA", "Referral Date" },
    { 0x300e, 0x0005, "TM", "" },
    { 0x300e, 0x0006, "UL", "Referring Service" },
    { 0x300e, 0x0008, "PN", "Initial RT Consult Date" },
    { 0x300e, 0x000a, "UL", "Primary Oncologist" },
    { 0x300e, 0x000c, "UL", "First Treatment Date" },
    { 0x300e, 0x000d, "UL", "Most Recent Treatment Date" },
    { 0x300e, 0x000e, "UL", "Final Treatment Date" },
    { 0x300e, 0x0010, "UL", "Treatment Protocols" },
    { 0x300e, 0x0012, "UL", "Treatment Intent" },
    { 0x300e, 0x0014, "UL", "Treatment Sites" },
    ...
    { 0x4008, 0x0117, "SQ", "Diagnosis Code Sequence" },
    ...
    { 0x7fe0, 0x0010, "ox", "Pixel Data" },
    { 0x7fe0, 0x0020, "OW", "Coefficients SDVN" },
    { 0x7fe0, 0x0030, "OW", "Coefficients SDHN" },
    { 0x7fe0, 0x0040, "OW", "Coefficients SDDN" },
    { 0x7fe1, 0x0000, "UL", "SPI Pixel Data Group Length" },
    { 0x7fe1, 0x0010, "UL", "SPI Compressed Pixel Data" },
