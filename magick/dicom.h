...
static const DicomInfo
  dicom_info[] =
  {
    ...
    { 0x0009, 0x0000, "xs", "SPI Identifying Group Length" },
    { 0x0009, 0x0010, "LO", "SPI Comments" },
    { 0x0009, 0x0015, "xs", "SPI Unique Identifier" },
    { 0x0009, 0x0016, "xs", "SPI DESC Descriptor" },
    { 0x0009, 0x0017, "xs", "SPI Special Identifier" },
    { 0x0009, 0x0040, "xs", "SPI Data Object Type" },
    { 0x0009, 0x0041, "xs", "SPI Data Object Subtype" },
    { 0x0009, 0x0061, "xs", "SPI Modality Type Extension" },
    { 0x0009, 0x00a0, "xs", "SPI Resulting Diagnosis" },
    { 0x0009, 0x00a1, "xs", "SPI Report Date" },
    { 0x0009, 0x00a2, "xs", "SPI Report Time" },
    { 0x0009, 0x1002, "OB", "" },
    { 0x0009, 0x1003, "OB", "" },
    ...
    { 0x0011, 0x0000, "xs", "SPI Patient Group Length" },
    { 0x0011, 0x0010, "xs", "SPI Shadow Owner Code - SPI ID" },
    { 0x0011, 0x0011, "xs", "SPI Shadow Owner Code - Siemens CMS ID" },
    { 0x0011, 0x1010, "xs", "SPI Organ" },
    { 0x0011, 0x1015, "xs", "SPI Allergy Indicator" },
    { 0x0011, 0x1020, "xs", "SPI Pregnancy" },
    { 0x0011, 0x1110, "xs", "SPI Registration Date" },
    { 0x0011, 0x1111, "xs", "SPI Registration Time" },
    { 0x0011, 0x1123, "xs", "SPI Used Patient Weight" },
    ...
    { 0x0019, 0x0000, "xs", "SPI Acquisition Group Length" },
    { 0x0019, 0x0010, "LO", "SPI Shadow Owner Code - Siemens CMS ID" },
    { 0x0019, 0x0011, "xs", "SPI Shadow Owner Code - Siemens CT ID" },
    { 0x0019, 0x0012, "xs", "SPI Shadow Owner Code - Siemens MR ID" },
    { 0x0019, 0x0013, "xs", "SPI Shadow Owner Code - Siemens CT Adjust ID" },
    { 0x0019, 0x0014, "xs", "SPI Shadow Owner Code - Siemens MR Adjust ID" },
    { 0x0019, 0x0015, "xs", "SPI Shadow Owner Code - Siemens Acquisition ID" },
